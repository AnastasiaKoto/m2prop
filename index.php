	...
	<div class="container">
		<div class="special-inner">
			<div class="special-bg">
				<img src="./assets/img/spec.png" alt="img">
			</div>
			<h2>
				<span>
					Особенности
			...
			<div class="tabs-hp-container">
				...
				<div class="tabs-hp-content">
					<div class="tabs-hp-content__item active" data-tab="1">
						<div class="hp-slider-navigation">
							<button class="hp-slider-arrow hp-slider-arrow-prev"><svg width="17" height="10"
							...
							<button class="hp-slider-arrow hp-slider-arrow-next"><svg width="17" height="10"
									viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
							...
							<div class="splide__track hp-slider__content">
								<ul class="splide__list">
									<li class="splide__slide hp-slider__slide">
										<p>
											Мы сделали метры разумными
										</p>
										<span>
											Пространство квартир максимально продумано: функциональные планировки и
											только полезные метры.
											Никаких длинных узких коридоров и темных углов. Больше площадь жилых комнат,
											удобное
											зонирование, места для гардеробных и постирочных — каждый квадратный метр
											квартиры приносит
											пользу
										</span>
									</li>
					...
					<div class="tabs-hp-content__item" data-tab="2">
						<div class="hp-slider-navigation">
							<button class="hp-slider-arrow hp-slider-arrow-prev"><svg width="17" height="10"
									viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
					...
					<div class="tabs-hp-content__item" data-tab="3">
						<div class="hp-slider-navigation">
							<button class="hp-slider-arrow hp-slider-arrow-prev"><svg width="17" height="10"
									viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
					...
					<div class="tabs-hp-content__item" data-tab="4">
						<div class="hp-slider-navigation">
							<button class="hp-slider-arrow hp-slider-arrow-prev"><svg width="17" height="10"
									viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
					...
					<div class="tabs-hp-content__item " data-tab="5">
						<div class="hp-slider-navigation">
							<button class="hp-slider-arrow hp-slider-arrow-prev"><svg width="17" height="10"
									viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
					...
					<div class="tabs-hp-content__item" data-tab="6">
						<div class="hp-slider-navigation">
							<button class="hp-slider-arrow hp-slider-arrow-prev"><svg width="17" height="10"
									viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
					...
					<div class="tabs-hp-content__item" data-tab="7">
						<div class="hp-slider-navigation">
							<button class="hp-slider-arrow hp-slider-arrow-prev"><svg width="17" height="10"
									viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
					...
					<div class="tabs-hp-content__item" data-tab="8">
						<div class="hp-slider-navigation">
							<button class="hp-slider-arrow hp-slider-arrow-prev"><svg width="17" height="10"
									viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path
				...
				<!-- Горизонтальный слайдер табов -->
				<div id="tabs-hp-slider" class="splide tabs-hp-slider">
					<div class="splide__track">
						<ul class="splide__list">
							<li class="splide__slide tabs-hp-slider__slide" data-tab="1"></li>
							<li class="splide__slide tabs-hp-slider__slide" data-tab="2"></li>
							<li class="splide__slide tabs-hp-slider__slide" data-tab="3"></li>
							<li class="splide__slide tabs-hp-slider__slide" data-tab="4"></li>
							<li class="splide__slide tabs-hp-slider__slide" data-tab="5"></li>
							<li class="splide__slide tabs-hp-slider__slide" data-tab="6"></li>
							<li class="splide__slide tabs-hp-slider__slide" data-tab="7"></li>
							<li class="splide__slide tabs-hp-slider__slide" data-tab="8"></li>
						</ul>
					</div>
				</div>
			</div>
